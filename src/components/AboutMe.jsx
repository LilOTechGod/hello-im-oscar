    ...
    <Container>
      <Row>
          ...
          <Card>
            ...
            <Card.Body>
              <blockquote className="blockquote mb-0">
                <p>
                  {" "}
                  You can't complain about the paradigm you live by, when you
                  have the ability to produce the paradigm you want to live in!{" "}
                </p>
        ...
        <Col sm={6} className="">
          <Card>
            <Card.Body>
              Passionate and solutions-driven full stack web developer. To
              provide unique perspectives on how end-users interact with
              websites and software platforms is the goal. Innovative
              problem-solver who is passionate about developing apps with a
              focus on mobile-first design and development. Strengths in
              creativity, teamwork, and building projects from ideation to
              execution. Experience in utilizing a combination of strong
              communication, collaboration, and analytical skills. Strong
